...
import { FaBell, FaBuilding, FaChartArea, FaChartLine, FaClipboardList, FaCog, FaDollarSign, FaEdit, FaFire, FaHandshake, FaHome, FaLink, FaMapMarkerAlt, FaPhoneAlt, FaSearch, FaTools, FaWind, FaWrench } from 'react-icons/fa';
export const metadata: Metadata = {
  title: 'Fire Damage Restoration SEO Services | Local SEO for Fire & Smoke Damage Companies',
  description: 'Expert SEO services for fire damage restoration companies. Dominate local search for fire cleanup, smoke damage restoration, soot removal, board-up services, and fire insurance claims. Proven fire restoration marketing strategies.',
  keywords: 'fire damage restoration SEO, fire damage company marketing, smoke damage SEO, soot removal marketing, fire cleanup SEO, fire restoration lead generation, local SEO for fire damage, fire damage near me SEO, fire insurance restoration marketing, commercial fire damage SEO, residential fire restoration marketing, fire board up SEO, fire odor removal marketing',
  openGraph: {
    title: 'Fire Damage Restoration SEO Services | Local SEO for Fire & Smoke Damage Companies',
    description: 'Expert SEO for fire damage restoration companies. Capture emergency leads and grow your fire restoration business with proven marketing strategies.',
    type: 'website'
  }
};
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white dark:bg-slate-950">
            ...
            __html: JSON.stringify([
              {
                ...
                "description": "Expert SEO services for fire damage restoration companies. Dominate local search for fire cleanup, smoke damage restoration, and emergency fire restoration services."
              }
            ])
          }}
        />
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 lg:order-1 text-white animate-fade-in">
                <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-gradient-to-r from-blue-500/20 via-indigo-500/20 to-purple-500/20 backdrop-blur-xl border border-blue-400/30 mb-8 animate-scale-in shadow-lg shadow-blue-500/20">
                  ...
                  <span className="text-sm font-bold text-white drop-shadow-lg">Emergency Fire Restoration SEO</span>
                </div>
                ...
                <p className="text-lg md:text-xl text-slate-200 mb-8 leading-relaxed animate-slide-up animation-delay-200 drop-shadow-lg">
                  After fire damage, property owners need immediate restoration services. Our 24/7 SEO strategies ensure your company appears first in emergency searches.
                </p>
                ...
                <div className="flex flex-wrap gap-8 pt-8 border-t border-white/10 animate-fade-in animation-delay-400">
                  ...
                  <div className="text-center">
                    <div className="text-3xl font-black bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent mb-1">1,300+</div>
        ...
        <CountriesGrid industrySlug="fire-damage-restoration-seo" industryIcon="🔥" />
        ...
        <section className="py-20 bg-white dark:bg-slate-950">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                { title: "Emergency Keyword SEO", description: "Rank first for urgent fire restoration searches in your area", icon: <FaBell className="w-6 h-6" />, color: "from-red-500 to-orange-500" },
                { title: "Local Pack Optimization", description: "Dominate Google Maps for fire damage contractor searches", icon: <FaMapMarkerAlt className="w-6 h-6" />, color: "from-blue-500 to-cyan-500" },
                { title: "24/7 Call Optimization", description: "Maximize emergency call conversions with click-to-call", icon: <FaPhoneAlt className="w-6 h-6" />, color: "from-green-500 to-emerald-500" },
                { title: "Insurance Keyword SEO", description: "Rank for fire damage insurance claim related searches", icon: <FaClipboardList className="w-6 h-6" />, color: "from-purple-500 to-pink-500" },
                { title: "Smoke Damage SEO", description: "Capture smoke odor and soot cleanup search traffic", icon: <FaWind className="w-6 h-6" />, color: "from-gray-500 to-slate-500" },
                { title: "Commercial Restoration SEO", description: "Target commercial property fire restoration leads", icon: <FaBuilding className="w-6 h-6" />, color: "from-orange-500 to-amber-500" }
              ].map((service, index) => (
        ...
        <IndustryStats 
          ...
          stats={[
            { value: "94%", label: "of fire victims search online for immediate restoration help", icon: <FaSearch className="w-6 h-6" />, color: "from-orange-500 to-red-500" },
            { value: "2hrs", label: "average decision time for choosing a fire restoration company", icon: "⏱️", color: "from-blue-500 to-cyan-500" },
            { value: "97%", label: "of fire restoration searches have urgent local intent", icon: <FaMapMarkerAlt className="w-6 h-6" />, color: "from-purple-500 to-pink-500" },
            { value: "$45K", label: "average residential fire restoration project value", icon: <FaDollarSign className="w-6 h-6" />, color: "from-green-500 to-emerald-500" }
          ]}
        />
        ...
        <ProcessTimeline 
          industry="Fire Damage Restoration"
          steps={[
            { step: 1, title: "Emergency Audit", description: "Analyze your local fire restoration market and emergency keyword opportunities.", icon: <FaSearch className="w-6 h-6" />, duration: "Week 1" },
            ...
            { step: 4, title: "Service Pages", description: "Create fire, smoke, and content restoration pages with emergency CTAs.", icon: <FaEdit className="w-6 h-6" />, duration: "Weeks 3-8" },
            { step: 5, title: "Local Domination", description: "Optimize GBP, build restoration citations, and generate emergency reviews.", icon: <FaMapMarkerAlt className="w-6 h-6" />, duration: "Ongoing" },
        ...
        <TopicClusterSection 
          industry="Fire Damage Restoration"
          pillars={[
            { title: "Fire Restoration Content", description: "Comprehensive fire damage service pages", topics: ["Fire damage repair", "Structural restoration", "Board-up services", "Debris removal"], icon: <FaFire className="w-6 h-6" /> },
            { title: "Smoke & Soot Content", description: "Dedicated smoke damage optimization", topics: ["Smoke odor removal", "Soot cleanup", "Air quality restoration", "HVAC cleaning"], icon: <FaWind className="w-6 h-6" /> },
            { title: "Insurance Content", description: "Insurance-focused educational content", topics: ["Claims process guide", "Documentation tips", "Working with adjusters", "Coverage questions"], icon: <FaClipboardList className="w-6 h-6" /> },
            { title: "Emergency Content", description: "Urgent response-focused pages", topics: ["24/7 response", "Emergency board-up", "What to do after fire", "Timeline expectations"], icon: <FaBell className="w-6 h-6" /> }
          ]}
        />
        ...
        <LocalSEOSignals 
          industry="Fire Damage Restoration"
          signals={[
            { title: "Google Business Profile", description: "Optimized with 24/7 hours, fire restoration categories, and emergency messaging", importance: "Critical", icon: <FaMapMarkerAlt className="w-6 h-6" /> },
            { title: "Restoration Citations", description: "Listings on Angi, HomeAdvisor, restoration directories, and insurance panels", importance: "Critical", icon: <FaClipboardList className="w-6 h-6" /> },
            ...
            { title: "Local Emergency Backlinks", description: "Links from local news, fire departments, and insurance agents", importance: "Medium", icon: <FaLink className="w-6 h-6" /> }
          ]}
        />
        ...
        <TrustSignals 
          industry="Fire Damage Restoration"
          customItems={[
            { icon: <FaFire className="w-6 h-6" />, title: "Fire Restoration Expertise", description: "Deep understanding of how fire victims search for help" },
            { icon: <FaChartLine className="w-6 h-6" />, title: "Emergency Results", description: "Proven 3-4x increases in emergency calls for restoration companies" },
            { icon: <FaBell className="w-6 h-6" />, title: "24/7 Optimization", description: "Strategies designed for after-hours emergency visibility" },
            { icon: <FaMapMarkerAlt className="w-6 h-6" />, title: "Local SEO Masters", description: "Dominate your service area for fire restoration searches" },
            ...
            { icon: <FaHandshake className="w-6 h-6" />, title: "Dedicated Support", description: "Direct access to your restoration SEO specialist" }
          ]}
        />
