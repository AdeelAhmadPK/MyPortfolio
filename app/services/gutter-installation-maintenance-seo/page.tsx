...
import { FaBriefcase, FaBuilding, FaCalendar, FaCamera, FaCertificate, FaChartArea, FaChartBar, FaChartLine, FaCog, FaDollarSign, FaEdit, FaHome, FaMapMarkerAlt, FaRocket, FaSearch, FaShieldAlt, FaTags, FaTools, FaTrophy, FaWrench } from 'react-icons/fa';;;
export const metadata: Metadata = {
  title: "Gutter Installation & Maintenance SEO Services | Local SEO for Seamless Gutter Companies",
  description: "Expert SEO services for gutter installation, cleaning, and repair companies. Dominate local search for seamless gutters, gutter guards, gutter cleaning, and gutter maintenance services. Proven gutter contractor marketing strategies.",
  keywords: "gutter installation SEO, gutter cleaning marketing, seamless gutter SEO, gutter repair company marketing, gutter guard installation SEO, gutter maintenance SEO, gutter contractor marketing, gutter company lead generation, local SEO for gutter companies, gutter near me SEO, rain gutter marketing, gutter replacement SEO, residential gutter marketing, commercial gutter SEO",
  openGraph: {
    title: "Gutter Installation & Maintenance SEO Services | Local SEO for Seamless Gutter Companies",
            ...
            __html: JSON.stringify([
              {
                ...
                "description": "Expert SEO services for gutter installation and maintenance contractors. Capture high-value gutter installation and maintenance leads."
              }
            ])
          }}
        />
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 lg:order-1 text-white animate-fade-in">
                <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-gradient-to-r from-blue-500/20 via-indigo-500/20 to-purple-500/20 backdrop-blur-xl border border-blue-400/30 mb-8 animate-scale-in shadow-lg shadow-blue-500/20">
                  ...
                  <span className="text-sm font-bold text-white drop-shadow-lg">Premium Gutter SEO Services</span>
                </div>

                <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-black mb-6 leading-tight animate-slide-up">
                  <span className="text-white drop-shadow-2xl">Gutter Installation & Maintenance</span>
                  <br />
                ...
                <p className="text-lg md:text-xl text-slate-200 mb-8 leading-relaxed animate-slide-up animation-delay-200 drop-shadow-lg">
                  Homeowners search for gutter installation and cleaning when they need seamless gutters, gutter guards, or emergency repairs. Our SEO strategies help your company dominate local search.
                </p>
        ...
        <section className="py-20 bg-gray-900/50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-400 max-w-2xl mx-auto">
                See what gutter industry professionals say about My SEO services
              </p>
            </div>
            <div className="grid md:grid-cols-3 gap-8">
              {[
                {
                  quote: "We went from scrambling for work in the off-season to having consistent leads year-round. The seasonal SEO strategy was a game-changer.",
                  author: "Mark T.",
                  company: "Seamless Gutter Installation",
                  rating: 5
                },
                {
                  quote: "Our fall cleaning schedule is booked solid weeks in advance now, and I have steady installation work throughout the year. Best investment we made.",
                  author: "Sarah L.",
                  company: "Full-Service Gutter Company",
                  rating: 5
                },
                {
                  quote: "They helped us dominate Google Maps for our service area. We're now the top choice for gutter services in three counties.",
                  author: "James P.",
                  company: "Regional Gutter Contractor",
                  rating: 5
                }
